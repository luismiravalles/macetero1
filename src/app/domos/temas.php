...
$sql = <<<EOT
	SELECT nombre,  valor, medida, addtime(hora,'0 6:0:0.0'), sensor.id, foto.foto
	FROM sensor
...
$sql = <<<EOT
SELECT id, nombre,  estado, addtime(hora,'0 6:0:0.0'), addtime(consultado,'0 6:0:0.0') from actuador where activo = 1
EOT;
